...
US_2020DV$Draft_DV_18_20 <- apply(US_2020DV[,c(6,7,9)], 1, function(x) trunc(mean(x)*1000)/1000)
...
#bins the draft design value data, above and below the 0.070ppm ozone NAAQS
US_2020DV$O3_NAAQS_Attainment <- cut(US_2020DV$Draft_DV_18_20,c(0,0.061,0.066,0.071,0.076, 0.08,0.150), include.lowest = T,labels = c('< 61','61-65','66-70','71-75','76-80','>80'))
