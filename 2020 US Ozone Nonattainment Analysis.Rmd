...
map_combined <- leaflet() %>% 
  ...
  addPolygons(data=US_2015_O3_NAA,
              stroke = TRUE,
              weight = 2,
              color = "black",
              smoothFactor = 0.2,
              ...
              popup = as.character(paste0(US_2015_O3_NAA$area_name," NAA","<br>",
                                          "Classification: ",US_2015_O3_NAA$classification))) %>%
  ...
  addLegend('bottomleft', pal = naa_pal, values = US_2015_O3_NAA$classification,
